...
import com.basic.javaframe.POJO.Frame_Role_User_POJO;
...
//        user.setLoginId(cu);
    ...
    public R getCheckedRole(@RequestParam String userGuid) {
        List<Frame_Role_User_POJO> roles = roleUserService.getCheckedRole(userGuid);
    ...
    public R getMenuByUserGuid(@RequestParam String userGuid) {
        //根据用户guid查询角色list
        List<com.basic.javaframe.POJO.Frame_Role_User_POJO> A = roleUserService.getCheckedRole(userGuid);
...
//		System.out.println(obj);
     ...
     * <p>Description: </p>
     *
     * @param roles(roleGuids)
     * @return
     * @author hero
     */
    @ApiOperation(value = "根据权限查询模块")
    @ResponseBody
    @RequestMapping(value = "/getMenuByRoleGuid", produces = "application/json;charset=utf-8", method = RequestMethod.POST)
    public R getMenuByRoleGuid(@RequestBody String[] roles) {
        //根据用户guid查询角色list
//        List<com.basic.javaframe.POJO.Frame_Role_User_POJO> A = roleUserService.getCheckedRole(userGuid);
